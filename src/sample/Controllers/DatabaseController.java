...
public class DatabaseController implements Initializable {
    ...
    //NNA: Make sure to fetch the database object from the Singleton to avoid re-initializing the database
    private DataBase db = DatabaseSingleton.getInstance().getDb();
    ...
    public void addNewProduct() {
        try {
            ...
            db.addItem(type, name, ingredients, weight, origin, details, price);
